...
<head>
  ...
  <style>
    ...
    .navbar-nav .nav-link:hover {
      color: #17a2b8; /* Primary color on hover */
    }

    .page-banner h1 {
      
      margin-top: 100px; /* Add margin to center vertically */
    }
...
<body>
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
      <div class="container">
        <a class="navbar-brand" href="#"><span class="text-success">cabinet</span>-Medical</a>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 wow fadeInUp">
          <h1 class="text-center mb-3">Welcome to Your cabinet medical Center</h1>
          <div class="text-lg">
          ...
          <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4 wow zoomIn">
              <div class="card-doctor">
                ...
                <div class="body">
                  <p class="text-xl mb-0">Dr.fatimaezzahra</p>
                  <span class="text-sm text-grey">General cabinet medical</span>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg-4 wow zoomIn">
              <div class="card-doctor">
                <div class="header">
                  <img src="../assets/img/doctors/MedicalDoctor.jpg" alt="">
                  <div class="meta">
                    <a href="#"><span class="mai-call"></span></a>
                    <a href="#"><span class="mai-logo-whatsapp"></span></a>
                  </div>
                ...
                <div class="body">
                  <p class="text-xl mb-0">Dr.ahmed tazzi</p>
            ...
            <div class="col-md-6 col-lg-4 wow zoomIn">
              <div class="card-doctor">
                ...
                <div class="body">
                  <p class="text-xl mb-0">Dr.meryem benzayd</p>
                  <span class="text-sm text-grey">General cabinet medical</span>
                </div>
              </div>
            </div>
    ...
    <div class="container">
      <div class="row px-md-3">
        ...
        <div class="col-sm-6 col-lg-3 py-3">
          ...
          <a href="#" class="footer-link">cabinet@temporary.net</a>
